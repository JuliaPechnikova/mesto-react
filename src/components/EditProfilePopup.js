...
function EditProfilePopup(props) {
  ...
  return (
    <PopupWithForm name="edit-profile" title="Редактировать профиль" buttonTitle={props.buttonTitle} theme="" isOpen={props.isOpen} onClose={props.onClose} onSubmit={handleSubmit}>
